...
const ZH: Record<string, string> = {
  ...
  "building.gold_jar": "金币罐",
  "building.gold_jar.desc": "装金币的罐子。罐里有多少就是你有多少——罐满了，进账的部分会流失。",
  "building.gold_jar.l1": "金币罐",
  "building.gold_jar.l1.desc": "一只陶罐立在石座上。",
  "building.gold_jar.l2": "金币罐 · 加固",
  "building.gold_jar.l2.desc": "罐子大了一圈，木架撑着，还接了一根引水的铜管。",
  "building.gold_jar.l3": "金币罐 · 三连",
  "building.gold_jar.l3.desc": "三只罐围着一座刻纹石台，装得下相当可观的一笔钱。",
