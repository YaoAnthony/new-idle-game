...
export const PALETTE = {
  ...
  /* ---- 家具小店改女巫小屋风（2026-08-26）----
   *
   * 棚布原来用 `shopAwning`（亮橙 #d9762f）+ 纯白，那是配奶油灰泥墙的
   * 欧式铺面色。换到乱石墙 + 木构架之后太跳——一块荧光招子贴在石头房上。
   * 收成**赤陶 + 亚麻**，明度压低、饱和度减半，仍然是"这儿有间铺子"的
   * 暖色信号，但站在主屋旁边像同一个村子的。
   */
  shopAwningWitch: "#a85f3c",      // 赤陶：棚布的深条
  shopAwningWitchLight: "#d8cdb8", // 亚麻：棚布的浅条
