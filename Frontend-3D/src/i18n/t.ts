...
const ZH: Record<string, string> = {
  ...
  "ui.news.line.resident_arc_done": "{who} 说出了一直藏在心里的事",
  ...
  "ui.news.headline.consign_sold": "寄售箱昨夜出了货",
  ...
  // ---- 个人剧情线（居民系统 13）----
  "event.arc_slime": "咕噜 · 怕黑",
  "event.arc_slime.settled": "咕噜搬来了",
  "event.arc_slime.afraid_of_dark": "陪他走到井边之后，他说自己怕黑",
  "event.arc_slime.lamp_lit": "灯亮了",
  "event.arc_slime.opened_up": "他说出了怕黑的原因",
  "event.arc_slime.done": "咕噜的这件事，说完了",
  "event.arc_fox": "阿茜 · 河对岸",
  "event.arc_fox.settled": "阿茜搬来了",
  "event.arc_fox.wants_shortcut": "她总念叨镇上，想开一条近路",
  "event.arc_fox.delivered_to_town": "你替她过了桥，路从此是通的",
  "event.arc_fox.brought_letter": "她从镇上带回一封不是她写的信",
  "event.arc_fox.done": "那封信拆开了",
  "event.arc_spirit": "薇尔 · 会发光的土地",
  "event.arc_spirit.settled": "薇尔搬来了",
  "event.arc_spirit.asked_to_plant": "她请你在她家旁边种点什么",
  "event.arc_spirit.planted": "土里有了一点光",
  "event.arc_spirit.taught_chimes": "她教了你风铃的事",
  "toast.parcel_delivered": "阿茜的小包交给了杂货铺。桥那头的路，从今天起是通的了。",
  ...
  "dlg.opening_sigh": "合上信纸",
  "dlg.opening_sigh.n1": "（叹气）老师总是这样……",
  "dlg.opening_door_locked": "推门",
  ...
  "guide.next": "下一页",
  "guide.page": "第 {n} 页",
  "guide.place_furniture.subtitle": "学会拿出家具、旋转方向、完成放置",
  "guide.kitchen.subtitle": "放好灶台、放锅、加食材、装盘",
  "guide.diary.subtitle": "创建任务、开始专注、领取奖励",
  "guide.backfill.title": "P 人也能领奖励",
  "guide.backfill.subtitle": "补录今天完成的事情，也可以获得奖励",
  "guide.book.title": "攻略查询器",
  "guide.book.search": "搜索攻略…",
  "guide.book.empty": "没有找到相关攻略",
  "guide.category.furniture": "家具摆放",
  "guide.category.cooking": "烹饪教学",
  "guide.category.diary": "日记本",
  "guide.category.rewards": "补录奖励",
  "guide.category.ambience": "白噪音",
  "guide.category.faq": "常见问题",
  "guide.tag.basic": "基础",
  "guide.tag.recommended": "推荐",
  "guide.tag.newbie": "新手",

  // ---- 成就（Core Data/achievements） ----
  "achievement.toast": "达成成就",
  "achievement.panel.title": "成就",
  "achievement.panel.done": "已完成",
  "achievement.panel.points": "获得成就点数",
  "achievement.panel.slogan": "收集每一个生活里的小美好！",
  "achievement.panel.claim": "领取",
  "achievement.panel.status_done": "已完成",
  "achievement.panel.status_progress": "进行中",
  "achievement.panel.status_locked": "未解锁",
  "achievement.panel.secret_title": "？？？",
  "achievement.panel.secret_desc": "达成后揭晓",
  "achievement.reward_title": "成就奖励",
  "achievement.category.all": "全部",
  "achievement.category.newbie": "新手",
  "achievement.category.life": "生活",
  "achievement.category.cooking": "烹饪",
  "achievement.category.furniture": "家具",
  "achievement.category.diary": "日记本",
  "achievement.category.collect": "收集",
  "achievement.category.hidden": "隐藏",
  "achievement.first_furniture.title": "第一次摆好家具",
  "achievement.first_furniture.desc": "成功放置 1 件家具",
  "achievement.first_plan.title": "今天也有计划",
  "achievement.first_plan.desc": "创建 1 次日记任务",
  "achievement.first_backfill.title": "P 人也能拿奖励",
  "achievement.first_backfill.desc": "完成 1 次补录任务",
  "achievement.journal_found.title": "魔女的本子",
  "achievement.journal_found.desc": "拿到桌上的日记本",
  "achievement.noise_lover.title": "白噪音爱好者",
  "achievement.noise_lover.desc": "使用白噪音 10 分钟",
  "achievement.little_cook.title": "小小料理人",
  "achievement.little_cook.desc": "完成 3 次烹饪",
  "achievement.home_chef.title": "家里的大厨",
  "achievement.home_chef.desc": "完成 20 次烹饪",
  "achievement.cozy_home.title": "温馨小屋",
  "achievement.cozy_home.desc": "摆放 10 件家具",
  "achievement.focused_day.title": "专注的一天",
  "achievement.focused_day.desc": "完成 5 次任务计时",
  "achievement.collector.title": "收藏家",
  "achievement.collector.desc": "获得 20 个异世界奖励",
  "achievement.burnt.title": "黑暗料理",
  "achievement.burnt.desc": "把一锅菜烧糊",
  "achievement.night_owl.title": "夜猫子",
  "achievement.night_owl.desc": "深夜开始一次专注",
  ...
  "loot.letter_attachment": "信里夹着的",
  "hint.mailbox": "看信箱",
  "hint.mailbox_unread": "有新信",
  "ui.cancel": "算了",
  "ui.mail.title": "信箱",
  "ui.mail.count": "{n} / {max} 封",
  "ui.mail.empty": "信箱是空的。",
  "ui.mail.pick_one": "点一封信看看。",
  "ui.mail.from": "{who} 寄来",
  "ui.mail.back": "回到信封",
  "ui.mail.postcard_art": "明信片 · 插图待画",
  "ui.mail.attached": "夹着：{what}",
  "ui.mail.write": "写信",
  "ui.mail.to": "写给",
  "ui.mail.attach_held": "夹上手里的：{what}",
  "ui.mail.attach_none": "手里没东西可夹",
  "ui.mail.send": "寄出",
  "ui.mail.outbox_pending": "还有 {n} 封在路上，明早送到。",
  "ui.mail.story_sender": "不知道谁",
  "ui.mail.unknown_sender": "某位邻居",
  ...
  "ui.craft": "制作",
  "ui.craft.recipes": "配方",
  "ui.craft.station": "工作台",
  "ui.craft.no_recipes": "还没有会做的东西。材料凑齐一半，配方就会出现在这里。",
  "ui.craft.pick": "选一个配方",
  "ui.craft.have": "有",
  "ui.craft.need": "需",
  "ui.cooking": "烹饪",
  ...
  "item.furniture_consign_box": "寄售箱",
  "item.furniture_consign_box.desc": "挂着吊牌的木箱。家具放进去，第二天一早就换成钱——只是收八折。",
