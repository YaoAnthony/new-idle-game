...
const ZH: Record<string, string> = {
  ...
  "farm.toast.giant_grown": "田里长出了一颗巨大{crop}！",
  "codex.section.crop": "作物",
  "codex.group.crop.all": "种过的",
  "achievement.first_harvest.title": "第一茬",
  "achievement.first_harvest.desc": "从田里收下第一格作物",
  "achievement.harvest_30.title": "小农人",
  "achievement.harvest_30.desc": "累计收下 30 格作物",
  "achievement.giant_crop.title": "巨大的收获",
  "achievement.giant_crop.desc": "收下一颗巨大果实",
  "time.under_minute": "不到 1 分钟",
  "time.minutes": "{m} 分钟",
  "time.hours": "{h} 小时",
  ...
  "item.witch_letter.desc": "门上拿下来的。紫色的蜡封上是一弯月牙。拿在手上按 F 拆开来读——读完它会烧掉。",
  "hint.golem_head": "头",
  // 22：两只手是零件。眼下没有获得剧情，/give golem_arm_left / golem_arm_right
  "item.golem_arm_left": "石傀儡的左手",
  "item.golem_arm_left.desc": "一整条青灰色的石臂，肩头是个圆榫。沉得像它的主人。",
  "item.golem_arm_right": "石傀儡的右手",
  "item.golem_arm_right.desc": "另一条石臂，拳头比小臂还宽。他拿这个砸东西。",
  "hint.golem_arm_left": "左手",
  "hint.golem_arm_right": "右手",
  "golem.hint.attach.head": "装上头",
  "golem.hint.attach.arm_left": "装上左手",
  "golem.hint.attach.arm_right": "装上右手",
  "golem.attached.arm_left": "左手嵌进肩窝，转了转。",
  "golem.attached.arm_right": "右手嵌进肩窝，转了转。",
  "golem.hint.dormant": "一尊没有头的石像",
  "golem.hint.build": "看看能盖什么",
  "golem.hint.talk": "和它说说话",
  ...
  "event.traveler_intro": "小鱼人来找魔女",
  "event.traveler_intro.knocking": "有人在门外敲门",
  "event.traveler_intro.met": "魔女不在，他说下次再来",
  "event.golem_intro": "石傀儡只会咔咔",
  "event.golem_intro.talked": "和他咔咔过一遍",
  ...
  // ---- 主线（Core Data/mainline） ----
  "mainline.tutorial": "教程",
  "mainline.tutorial.letter": "门上的信封",
  "mainline.tutorial.boxes": "拆开搬家的箱子",
  "mainline.tutorial.traveler": "小鱼人来敲门",

  // ---- 图鉴（Core Data/codex：分区、分组是来源表的键；条目名字 / 介绍走 item.* / pet.* 自己的键） ----
  "codex.toast": "图鉴收录",
  "codex.panel.title": "图鉴",
  "codex.panel.collected": "已收录",
  "codex.panel.unknown_name": "？？？",
  "codex.panel.no_desc": "介绍还没写。",
  "codex.panel.seen_on": "初见",
  "codex.panel.detail_hint": "点一张卡片看介绍",
  "codex.section.furniture": "家具",
  "codex.section.resident": "居民",
  "codex.group.surface.floor": "落地",
  "codex.group.surface.wall": "挂墙",
  "codex.group.surface.surface": "台面小物",
  "codex.group.role.pet": "伙伴",
  "codex.group.role.worker": "帮手",
  "codex.group.role.merchant": "商人",
  "codex.group.role.resident": "邻居",
  ...
  // 小鱼人第一次来（居民系统 20）。用户给的原话顺出来的，改台词只改这里
  // ---- 石傀儡醒来后的"咔咔"（Core Data/dialogues/golemTalk，用户原话照抄） ----
  "dlg.golem_first_talk": "石傀儡 · 咔咔",
  "dlg.golem_first_talk.n1": "咔咔咔",
  "dlg.golem_first_talk.n2": "....?",
  "dlg.golem_first_talk.n3": "咔咔",
  "dlg.golem_first_talk.n4": "咔咔？",
  "dlg.golem_first_talk.n5": "咔咔咔",
  "dlg.golem_first_talk.n6": "咔咔咔咔？",
  "dlg.golem_first_talk.n7": "....",
  "dlg.golem_first_talk.n8": "咔咔?",
  "dlg.golem_silent": "石傀儡 · ....",
  "dlg.golem_silent.n1": "....",
  // 22：装齐两只手 / 给他看图纸 / 解锁之后按 F（用户原话）
  "dlg.golem_arms": "石傀儡 · 阿咔咔咔",
  "dlg.golem_arms.n1": "阿咔咔咔！",
  "dlg.golem_blueprint": "石傀儡 · 哇咔咔",
  "dlg.golem_blueprint.n1": "哇咔咔！",
  "dlg.golem_ready": "石傀儡 · 咔咔？",
  "dlg.golem_ready.n1": "咔咔？",
  "dlg.golem_ready.build": "建点什么",
  "dlg.golem_ready.nothing": "没事",
  "dlg.fish_trader_knocks": "小鱼人 · 敲门",
  "dlg.fish_trader_knocks.n1": "魔女在吗？我找她有点事要谈。",
  "dlg.fish_trader_knocks.n2": "她出门了。",
  "dlg.fish_trader_knocks.n3": "她明明约了今天交易的……又是这样！",
  "dlg.fish_trader_knocks.n4": "那她什么时候回来？",
  "dlg.fish_trader_knocks.n5": "我也不清楚。",
  "dlg.fish_trader_knocks.n6": "（跺了跺脚）",
  "dlg.fish_trader_knocks.n7": "那我也不想白来。你看看我这儿，有什么你需要的？",
  "dlg.fish_trader_knocks.n8": "我……没钱。",
  "dlg.fish_trader_knocks.n9": "……游过来很费劲的好吗？！",
  "dlg.fish_trader_knocks.n10": "好吧好吧……那我下次再来。",
  ...
  // 四档，每档是一整套（像素比 / 抗锯齿 / 泛光 / 阴影 / 积水）。副标题写关键那几项
  "ui.settings.quality_smooth": "流畅",
  "ui.settings.quality_smooth_desc": "像素比 1×・关后处理・无阴影。笔记本省电、最不容易掉帧",
  "ui.settings.quality_balanced": "均衡",
  "ui.settings.quality_balanced_desc": "像素比 1.5×・抗锯齿 4×・有阴影。Retina 屏上看不太出糊，但稳 60 帧",
  "ui.settings.quality_high": "高清",
  "ui.settings.quality_high_desc": "像素比 2×・抗锯齿 4×・开泛光。画面最干净，像素是均衡档的两倍多",
  "ui.settings.quality_ultra": "极致",
  "ui.settings.quality_ultra_desc": "高清基础上加雨天积水与倒影（雨天会把整个场景多画一遍）",
  "ui.settings.auto_low_power": "自动模式时省电",
  "ui.settings.auto_low_power_hint": "专注期间角色自己过日子，这段时间自动压到流畅档，结束再调回来",
