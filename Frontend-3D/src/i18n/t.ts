...
const ZH: Record<string, string> = {
  ...
  "dlg.first.n7":
    "（苔苔在墙角坐下来，卷芽还没卷回去。它偷偷瞄了你好几眼，好像有一肚子问题没问完）",
  ...
  "item.furniture_fish_tank.desc": "两条小橙鱼住在里面，看着看着就出神了。",
